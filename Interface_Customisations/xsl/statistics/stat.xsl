		...
		<form name="statForm">
			<table cellspacing="2" border="0" align="left">
				...
				<tr>
					<td colspan="3">
<!--
						<a href="javascript:injectServiceResponse('stat.requests.csv','stat.tableExportDiv')">Records by custodian</a>&#160;
...
-->
			    ...
			    <br/>
						<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=users_groups', 'stat.tableExportDiv')">
					Users (all)</a>&#160;

                            <br/>

						<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=records_custodian','stat.tableExportDiv')">
					Records by Custodian (all)</a>&#160;
				<br/>
						<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=records_date_updated','stat.tableExportDiv')">
					Records by Update Date (last updated > 3 months ago)</a>&#160;
			  <br/>
						<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=records_orl','stat.tableExportDiv')">
					Records by ORL (all)</a>&#160;
			  <br/>
						<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=records_status','stat.tableExportDiv')">
					Records by Status</a>&#160;
			  <br/>
