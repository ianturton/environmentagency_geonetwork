...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <sch:pattern>
        ...
        <sch:rule context="//gmd:MD_Metadata">
            ...
            <sch:assert test="gmd:metadataStandardName/gco:CharacterString and gmd:metadataStandardName/gco:CharacterString = 'EAMP'">$loc/strings/UK999.alert.name</sch:assert>
